            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <div class="main-page">
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-primary" href="manage-students-teacher.php">
                                            <?php
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="manage-subjects-teacher.php">
                                            <?php
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top:1%;">
                                        <a class="dashboard-stat bg-warning" href="manage-classes-teacher.php">
                                            <?php
                        ...
                        <!--  Dynamic Chart using canvas charts -->
                        <?php
                        // dynamic charts using canvas charts
                        /*
                        $dataPoints = array(
                        ...
                        mysqli_select_db($link, "srms");

                        // Modify the SQL query to join tblresult and tblsubjects to get SubjectName
                        $res = mysqli_query($link, "SELECT r.SubjectId, s.SubjectName, AVG(r.marks) AS avg_marks 
                            FROM tblresult r
                        ...
                        while ($row = mysqli_fetch_array($res)) {
                            $dataPoints[] = array("y" => $row['avg_marks'], "label" => $row['SubjectName']);
                        }
                        ...
                        <section class="content">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <h3 class="panel-title">Average Marks Distribution</h3>
                                            </div>
                            ...
                            <script src="js/canvasjs/canvasjs-chart-3.7.23/canvasjs.min.js"></script>
                        </section>
